...
class LANboardConfig(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_PAUSE_MEDIA = "pause_media_during_recording"
    ...
    // v2 §5.4: pause other apps' media during recording (audio focus). Default ON.
    var pauseMediaDuringRecording: Boolean
        get() = prefs.getBoolean(KEY_PAUSE_MEDIA, true)
        set(value) = prefs.edit().putBoolean(KEY_PAUSE_MEDIA, value).apply()
